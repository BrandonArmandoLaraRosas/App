...
public class Modelo_listaproductos implements  Interface_Listaproductos{
    ...
    String URL="http://189.240.192.140/Webservices20221091/listaproductos.php";
    ...
    public void MostrarListaBusqueda(String busqueda) {
        productos.clear();
        String busquedaURL = "http://189.240.192.140/Webservices20221091/buscarProductos.php"; // URL diferente para búsqueda
